...
use crate::{
    services::{code_executor::CodeExecutor, pipe_processor::pipe_processor::PipeProcessor},
...
impl Parser {
    pub fn create(pipe_processor: PipeProcessor) -> Self {
        Self {
            pipe_processor: Arc::new(pipe_processor),
        }
    }
...
mod tests {
    ...
    use crate::services::{pipe_processor_presets::user_pipe_processor, template_env::TemplateEnv};
