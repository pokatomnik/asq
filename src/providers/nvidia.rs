...
static API_URL: &'static str = "https://integrate.api.nvidia.com/v1";

pub(crate) fn init_nvidia() -> anyhow::Result<OpenAILikeProvider> {
    let name = ask_name("Specify Nvidia provider name")?;
