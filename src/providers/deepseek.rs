...
use crate::providers::openai_like_provider::{
    OpenAILikeProvider, ask_model, ask_name, ask_token_key,
};
use crate::utils::init_interactive::InitInteractive;

static API_URL: &'static str = "https://api.deepseek.com";

pub(crate) fn init_deepseek() -> anyhow::Result<OpenAILikeProvider> {
